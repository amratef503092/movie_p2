...
class AddMainShops extends StatefulWidget {
  const AddMainShops({Key? key}) : super(key: key);

  @override
  State<AddMainShops> createState() => _AddMainShopsState();
}

class _AddMainShopsState extends State<AddMainShops> {
  @override
